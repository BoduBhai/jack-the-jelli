// Shared styling for the auth forms, mirroring
// features/admin/lib/product-form.ts so the two feature areas stay visually
// consistent without coupling to each other.
